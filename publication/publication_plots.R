...
par(mar = c(0.5, 4, 0.1, 1))
fig8_plotEpiNow2("ST3RC", transmission_EpiNow,"deepskyblue3", "deepskyblue", FALSE, c(110, 200), c(0, 2), title = "")
...
fig8_plotTimTam("SB4RC", introduction_TimTam, c(100, 98, 88, 78, 68, 60, 51, 42, 34, 16, 0), 98, "goldenrod3", "goldenrod1", TRUE, c(1, 120), c(0,8), title = "")
par(mar = c(0.5, 2, 3, 1))
fig8b_plotrt("SS3OC", sampling_combined,"darkolivegreen4", "darkolivegreen3", FALSE, c(1, 100), c(0, 5), 4, title = "Sampling Scenario")
par(mar = c(0.5, 2, 0.1, 1))
fig8b_plotEpiNow2("SS3OC", sampling_EpiNow,"deepskyblue3", "deepskyblue", FALSE, c(1, 100), c(0,5), title = "")
fig8b_plotBDSky("SS3OC", sampling_BDSky, c(0.29, 0.2575, 0.2192, 0.1973, 0.1767, 0.1562, 0.1342, 0.0932, 0.0521, 0.0), 94, "firebrick3", "firebrick1", FALSE, c(1, 100), c(0,5), title = "")
par(mar = c(4, 2, 0.1, 1))
fig8b_plotTimTam("SS3OC", sampling_TimTam, c(100, 94.0, 80.0, 72.0, 64.5, 57.0, 49.0, 34.0, 19.0, 0), 94, "goldenrod3", "goldenrod1", TRUE, c(1, 100), c(0,5), title = "")
par(mar = c(0.5, 2, 3, 1))
fig8b_plotrt("ST3RC", transmission_combined,"darkolivegreen4", "darkolivegreen3", FALSE, c(110, 200), c(0, 2), 4, title = "Transmission")
text(180, 1.75, "EpiFusion", cex = 1)
par(mar = c(0.5, 2, 0.1, 1))
fig8b_plotEpiNow2("ST3RC", transmission_EpiNow,"deepskyblue3", "deepskyblue", FALSE, c(110, 200), c(0, 2), title = "")
text(180, 1.75, "EpiNow2", cex = 1)
fig8b_plotBDSky("ST3RC", transmission_BDSky, c(2, 1.09, 1.05, 1.01, 0.98, 0.959, 0.93, 0.87, 0.82, 0.5, 0.0), 500, "firebrick3", "firebrick1", FALSE, c(110, 200), c(0,2), title = "")
text(180, 1.75, "BDSky", cex = 1)
par(mar = c(4, 2, 0.1, 1))
fig8b_plotTimTam("ST3RC", transmission_TimTam, c(450, 400, 383, 369, 358, 350, 339, 318, 300, 0), 500, "goldenrod3", "goldenrod1", TRUE, c(110, 200), c(0,2), title = "")
